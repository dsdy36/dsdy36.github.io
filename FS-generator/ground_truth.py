...
def parse_readme(readme_text: str) -> dict[str, dict[str, list[str]]]:
    ...
    Returns:
        ...
        'bad' includes both ❌ Error pattern and ⚠️ Mistake to include sections.
    """
    ...
    for i in range(1, len(sections), 2):
        ...
        # Extract ⚠️ Mistake to include — stored separately from Error patterns.
